...
(function (AnimationType) {
    ...
    AnimationType[AnimationType["WALKBACK"] = 3] = "WALKBACK";
...
var Player = (function (_super) {
    ...
    Player.prototype.Draw = function (context, location) {
        ...
        if (this.animationType === 0 /* IDLE */) {
            ...
            //TODO
        } else if (this.animationType === 3 /* WALKBACK */) {
            context.drawImage(this.spriteImg, 0 + (this.animationFrame * this.spriteWidth), 0 + (this.spriteWidth * 4), this.spriteWidth, this.spriteHeight, location.getX() - (.5 * this.imgWidth), location.getY() - (.8 * this.imgHeight), this.imgWidth, this.imgHeight);
        } else {
            //TODO handle error
